...
import com.mmm.mvideo.common.Log;
import com.mmm.mvideo.common.StringUtils;
...
public class MyMediaController extends FrameLayout {
	...
	public void setAnchorView(View view) {
		...
		if (!mFromXml) {
			...
			mWindow.setWidth(mAnchor.getWidth() - 10);
	...
	private void initControllerView(View v) {
		...
		mExpandButton = (ImageButton) v.findViewById(R.id.mediacontroller_expand_video);
	...
	public void show(int timeout) {
		if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
			...
			if (mFromXml) {
				...
				Rect anchorRect = new Rect(location[0] + 5, location[1], location[0] + mAnchor.getWidth() - 5, location[1] + mAnchor.getHeight());
	...
	private void updateExpandShink() {
		if (mExpandButton == null)
			return;

		if (isShowExpandImage)
			mExpandButton.setImageResource(R.drawable.btn_expand_video);
		else
			mExpandButton.setImageResource(R.drawable.btn_minimize_video);
	}
	...
	public boolean isShowExpandImage() {
		return isShowExpandImage;
	}

	public void setShowExpandImage(boolean isShowExpandImage) {

		this.isShowExpandImage = isShowExpandImage;
		updateExpandShink();
	}
